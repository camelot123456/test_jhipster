...
export const CategoryDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="demoJhipsterSpringReactApp.category.delete.question">
        <Translate contentKey="demoJhipsterSpringReactApp.category.delete.question" interpolate={{ id: categoryEntity.id }}>
