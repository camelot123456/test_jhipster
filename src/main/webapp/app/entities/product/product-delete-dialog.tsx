...
export const ProductDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="demoJhipsterSpringReactApp.product.delete.question">
        <Translate contentKey="demoJhipsterSpringReactApp.product.delete.question" interpolate={{ id: productEntity.id }}>
